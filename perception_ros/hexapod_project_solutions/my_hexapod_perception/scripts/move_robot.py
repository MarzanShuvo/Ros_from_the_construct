...
class MovePhantomX(object):
    ...
    def __init__(self, speed_limit=0.2):
        ...
        self._linear_max = speed_limit
        self._linear_min = speed_limit
        self._angular_max = speed_limit
        self._angular_min = speed_limit
...
def main():
    ...
    movePhantomX_object = MovePhantomX()
    twist_object = Twist()
    ...
    def shutdownhook():
        ...
        movePhantomX_object.clean_class()
    ...
    while not ctrl_c:
        movePhantomX_object.move_robot(twist_object)
        rate.sleep()
