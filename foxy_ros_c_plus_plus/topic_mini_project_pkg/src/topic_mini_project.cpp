...
class TopicMiniProject : public rclcpp::Node {
public:
  TopicMiniProject() : Node("mini_project") {
    publisher_ = this->create_publisher<geometry_msgs::msg::Twist>("cmd_vel", 10);

    subscription_ = this->create_subscription<sensor_msgs::msg::LaserScan>(
      "/kobuki/laser/scan", 10, std::bind(&TopicMiniProject::topic_callback, this, _1));
...
int main(int argc, char *argv[]) {
  ...
  rclcpp::spin(std::make_shared<TopicMiniProject>());
  rclcpp::shutdown();
  return 0;
}